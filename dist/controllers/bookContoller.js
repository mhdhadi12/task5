...
const dataBuku = (Req, Res, mockNext) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const book = yield Buku_1.Book.find();
        Res.status(200).json((0, apiResponse_1.default)(true, "Data Buku Tersedia", { book }));
    }
    catch (error) {
...
const detailBuku = (Req, Res, mockNext) => __awaiter(void 0, void 0, void 0, function* () {
...
const deleteBuku = (Req, Res, mockNext) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = Req.params;
    try {
...
const updateBuku = (Req, Res, mockNext) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = Req.params;
    try {
