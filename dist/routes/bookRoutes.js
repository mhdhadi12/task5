...
const bookContoller_1 = require("../controllers/bookContoller");
 ...
 */
routerBuku.get("/data", bookContoller_1.dataBuku);
/**
 * @swagger
 * /api/buku/data/{id}:
 *   get:
 ...
 */
routerBuku.get("/data/:kodebuku", bookContoller_1.detailBuku);
/**
 * @swagger
 * /api/buku/tambah:
 *   post:
 ...
 */
routerBuku.post("/tambah", authMiddleware_1.protect, bookContoller_1.TambahBuku);
/**
 * @swagger
 * /api/buku/data/{id}:
 *   put:
 ...
 *         description: Token tidak valid atau tidak ada
 */
routerBuku.put("/data/:id", authMiddleware_1.protect, bookContoller_1.updateBuku);
/**
 * @swagger
 * /api/buku/data/{id}:
 *   delete:
 ...
 *         description: Token tidak valid atau tidak ada
 */
routerBuku.delete("/data/:id", authMiddleware_1.protect, bookContoller_1.deleteBuku);
